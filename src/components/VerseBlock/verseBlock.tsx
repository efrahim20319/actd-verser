...
const VerseBlock: FunctionComponent<VerseBlockProps> = ({ verseNumber, selected }) => {
    return (<div className={tm(
        "bg-slate-300 flex justify-center items-center h-12  font-bold text-white rounded-sm hover:bg-slate-500 cursor-pointer transition-all duration-300 ease-linear",
